...
echo "Running sevntu instance '$1'"

echo "Cleaning..."
echo "./sevntu_launch_diff.sh -clean"
./sevntu_launch_diff.sh -clean
...
if [ "$4" == "true" ]; then
	...
	echo "./sevntu_launch_diff.sh $3 $CONFIG -patchOnly"
	./sevntu_launch_diff.sh $3 $CONFIG -patchOnly
	...
	echo "./sevntu_launch_diff.sh $3 $CONFIG"
	./sevntu_launch_diff.sh $3 $CONFIG
...
echo "Sevntu instance '$1' Complete for PR branch '$3' and $CONFIG_TEXT"
exit 0
